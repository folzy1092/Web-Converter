...
Курсы обновляются каждые 15 минут через [fawazahmed0/currency-api](https://github.com/fawazahmed0/currency-api), флаги — через [flagcdn.com](https://flagcdn.com). Без сборки, без npm-зависимостей.
...
| `alarms` | Обновлять курсы каждые 15 минут в фоне |
